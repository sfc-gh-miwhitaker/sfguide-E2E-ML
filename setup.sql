...
-- Grant full privileges to ACCOUNTADMIN for troubleshooting/admin access
GRANT ALL PRIVILEGES ON DATABASE E2E_SNOW_MLOPS_DB to ROLE ACCOUNTADMIN;
GRANT ALL PRIVILEGES ON SCHEMA MLOPS_SCHEMA to ROLE ACCOUNTADMIN;
GRANT ALL PRIVILEGES ON WAREHOUSE E2E_SNOW_MLOPS_WH to ROLE ACCOUNTADMIN;
